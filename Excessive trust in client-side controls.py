...
def get_csrf_token(s, url):
    r = s.get(url, verify=False, proxies=proxies) //verify ssl
    soup = BeautifulSoup(r.text, 'html.parser') //r.txt extraxt the body and make it usable in code by parsing it 
